    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-title">
                <h4>Ubah Foto Galeri</h4>

            </div>
            <div class="card-body">
                <div class="basic-elements">
                    <form action="/administrator/gallery/update/{{ $dataKonten->id_gal }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="album_gallery">Keterangan</label>
                                    <textarea class="textarea_editor form-control" rows="15" placeholder="Keterangan foto.." style="height:250px" id="album_gallery" name="album_gallery"><?= $dataKonten->album_gal ?></textarea>
                                    @error('album_gallery') 
