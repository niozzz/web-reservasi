                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_menu" name="nama_menu" class="form-control" autofocus value="{{ old('nama_menu') }}">
                                    @error('nama_menu') 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="jenis_menu" name="jenis_menu" class="form-control" value="{{ old('jenis_menu') }}">
                                    @error('jenis_menu') 
                                    <label class="text-danger ">
                                        {{$message}}
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kategori_menu" name="kategori_menu" class="form-control" value="{{ old('kategori_menu') }}">
                                    @error('kategori_menu') 
                                    <label class="text-danger ">
                                        {{$message}}
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="harga_menu" name="harga_menu" class="form-control" autofocus value="{{ old('harga_menu') }}">
                                    @error('harga_menu') 
                                    <label class="text-danger ">
                                        {{$message}}
                                    </label>
